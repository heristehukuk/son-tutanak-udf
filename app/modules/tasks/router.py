...
def page_html(user, case, tasks, stats, tmpls, checklist):
...
async def tasks_page(request: Request, case_id: str = "", case_no: str = "", applicant_name: str = "", file_type: str = "", start_date: str = ""):
    ...
    return page_html(u,case,list_tasks(u["id"],case_id),global_stats(u["id"]),templates(u["id"]),document_checklist(u["id"],case_id))
