...
class PendingMergeRepository(ABC):
    @abstractmethod
    def create(self, record: dict) -> dict: ...
    @abstractmethod
    def get(self, pending_id: str) -> Optional[dict]: ...
    @abstractmethod
    def get_by_key(self, pending_key: str) -> Optional[dict]: ...
    @abstractmethod
    def update(self, pending_id: str, values: dict) -> Optional[dict]: ...
    @abstractmethod
    ...
    def list_all(self) -> list[dict]: ...
    @abstractmethod
    def list_expired(self, cutoff: str) -> list[dict]: ...
...
class SurveyAnswerRepository(ABC):
    ...
    def upsert(self, answer: dict) -> dict:
        """(question_id, user_id) icin varsa gunceller, yoksa olusturur."""
        ...
    @abstractmethod
    def list_for_survey(self, survey_id: str) -> list[dict]: ...
    @abstractmethod
    ...
    def has_answered(self, survey_id: str, user_id: str) -> bool:
        """Kullanici bu anketin en az bir sorusunu cevaplamis mi (anketi 'tamamladi' saymak icin)."""
        ...
