...
-- Artik aktif: app/surveys/service.py + app/surveys/routes.py bu tablolari
-- gercekten okuyup yaziyor (repository katmani uzerinden).
-- =====================================================================
...
-- Var olan Supabase projelerinde tablolar zaten olusmus olabilir; eksik
-- sutunlari/indeksleri bozmadan tamamla.
...
-- Bir kullanici bir soruyu bir kez cevaplar; tekrar gonderirse UPSERT ile guncellenir.
